...
specializing in TypeScript, ReactJS, and NodeJS. Core contributor to \
business intelligence tools and logging micro- services, achieving \
significant performance improvements and scalability. Proven track \
record in mentoring, component library development, and data \
visualization. Recognized for significant performance improvements \
and effective data visualization solutions.",
  ...
  contact: {
    ...
    social: {
      GitHub: {
        name: "GitHub",
        url: "https://github.com/utkarsh22garg",
        icon: Icons.github,
      ...
      LinkedIn: {
        name: "LinkedIn",
        url: "https://www.linkedin.com/in/utkarsh22garg",
        icon: Icons.linkedin,
        navbar: true,
      },
      X: {
  ...
  education: [
    {
      school: "Motilal Nehru National Institue of Technology Allahabad",
      href: "https://mnnit.ac.in",
